import { Component, OnInit, AfterViewInit, HostListener, Renderer2, ElementRef,EventEmitter,Output } from '@angular/core';
...
export class BooksComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.shuffleBooks();  // Shuffle the books array
    this.createRows();
    this.rows.forEach(row => {
      row.forEach(book => {
        book.positionClass = this.getRandomPositionClass();
      });
    });
  }
  ...
  getBooks(): Book[] {
    ...
    return [
      { title: 'Latino Art on Campus', id: 1, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: true, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Native American Presence in Arts on Campus', id: 3, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: true, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Japanese Art at Dartmouth', id: 4, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: true, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Hop\'s Impact as a regional center', id: 5, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: true, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id: 5, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'History Book', id: 6, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Old Book', id: 7, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Ancient Tales', id: 8, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Mystery Novel', id: 9, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Science Fiction', id: 10, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id: 11, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'History Book', id: 12, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Old Book', id: 13, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Ancient Tales', id: 14, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Mystery Novel', id: 15, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Science Fiction', id: 16, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id: 17, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable:false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'History Book', id: 18, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Science Fiction', id: 19, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id:20, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'History Book', id: 21, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Old Book', id: 22, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Ancient Tales', id: 23, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Mystery Novel', id: 24, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Science Fiction', id: 25, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id: 26, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable:false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'History Book', id: 27, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Science Fiction', id: 28, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
      { title: 'Fantasy World', id: 29, decoration: ['assets/Dartmouth.png'], image: 'assets/1.jpg', isAvailable: false, color: this.getRandomColor(), orientation: 'vertical' },
    ];
  }

  getRandomColor(): string {
    const colors = ['#2c3e50', '#34495e', '#1abc9c', '#16a085', '#e74c3c', '#c0392b', '#f39c12', '#d35400', '#27ae60', '#2ecc71'];
  ...
  createRows(): void {
    for (let i = 0; i < this.m; i++) {
      this.rows[i] = this.books.slice(i * this.n, (i + 1) * this.n);
    }
  }

  onBookClick(book: Book): void {
    console.log(book);
    this.myFunction(book.id.toString());
  }

  @HostListener('window:resize')
  adjustTitleOrientation(): void {
    setTimeout(() => {
      const bookElements = this.el.nativeElement.querySelectorAll('.book-spine .book-title');
      bookElements.forEach((el: HTMLElement, index: number) => {
        const elHeight = el.offsetHeight;
        const elScrollHeight = el.scrollHeight;

        if (elScrollHeight > elHeight) {
          this.books[index].orientation = 'horizontal';
          this.renderer.addClass(el, 'horizontal');
          this.renderer.removeClass(el, 'vertical');
        } else {
          this.books[index].orientation = 'vertical';
          this.renderer.addClass(el, 'vertical');
          this.renderer.removeClass(el, 'horizontal');
        }
      });
    });
  }
  ...
  adjustFontSize(): void {
    setTimeout(() => {
      const bookElements = this.el.nativeElement.querySelectorAll('.book-spine .book-title');
      bookElements.forEach((el: HTMLElement) => {
        let fontSize = parseInt(window.getComputedStyle(el).fontSize, 10);
        const maxHeight = el.parentElement!.offsetHeight - 40; // Adjust for padding/margins
        const maxWidth = el.parentElement!.offsetWidth - 20; // Adjust for padding/margins
        ...
        while ((el.scrollHeight < maxHeight && el.scrollWidth < maxWidth) && fontSize < 18) {
          fontSize += 1;
          this.renderer.setStyle(el, 'font-size', `${fontSize}px`);
        }
      });
